Feature: allows creating movieEntity descriptions
  Background:
  ...
  Scenario: an admin user can create and list movies
    ...
    When the user types the "create movieEntity Sátántangó drama 450" command
    And the user types the "list movies" command
    Then the next line of the output is "Sátántangó (drama, 450 minutes)"

  @grade2-requirement
  Scenario: an admin user can update a movieEntity
    Given the user types the "sign in privileged admin admin" command
    And the user types the "create movieEntity Sátántangó dram 450" command
    When the user types the "update movieEntity Sátántangó drama 450" command
    And the user types the "list movies" command
    Then the next line of the output is "Sátántangó (drama, 450 minutes)"

  @grade2-requirement
  Scenario: an admin user can delete a movieEntity
    Given the user types the "sign in privileged admin admin" command
    And the user types the "create movieEntity Sátántangó drama 450" command
    When the user types the "delete movieEntity Sátántangó" command
    And the user types the "list movies" command
